...
def simulate_worker_upload(num_tasks=5, num_workers=15):
    ...
    # --------------------------
    # 固定的工人成本矩阵 (15个工人 × 5个任务)
    # 注意：工人i的成本对应任务0-4（任务1-5）
    # --------------------------
    raw_costs = [
        [26, 14, 21, 29, 30],  # 工人1
        [15, 29, 11, 11, 19],  # 工人2
    ...
    # --------------------------
    # 固定的任务质量矩阵 (5个任务 × 15个工人)
    # --------------------------
    raw_quals = [
        [13, 8, 12, 7, 8, 9, 7, 15, 9, 10, 6, 15, 8, 6, 8],  # 任务1
        [5, 13, 13, 15, 6, 9, 6, 13, 11, 15, 15, 8, 14, 7, 6],  # 任务2
        [6, 11, 6, 12, 8, 14, 10, 15, 10, 7, 10, 12, 11, 11, 13],  # 任务3
        [6, 9, 13, 13, 10, 11, 6, 5, 6, 13, 8, 8, 14, 5, 8],  # 任务4
        [10, 15, 13, 14, 12, 11, 6, 11, 15, 5, 15, 6, 6, 6, 7]  # 任务5
    ]
