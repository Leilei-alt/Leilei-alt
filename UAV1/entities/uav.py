...
from core.ecdsa_utils import generate_ecdsa_keypair, sign_message, verify_signature

from dataclasses import dataclass
from blspy import G1Element, G2Element
from core.bls_utils import generate_bls_keypair as generate_bls_keypair_real
...
def verify_uav_signature(request: AccessRequest, uav_public_key) -> bool:
...
class UAV:
    def __init__(self, uav_id: str, prime: int):
        ...
        # BLS key pair for batch-auth experiment
    ...
    def generate_bls_access_request(
        ...
        signature = bls_sign_message(
            self.bls_private_key,
            temp_request.message_to_sign(),
        )
